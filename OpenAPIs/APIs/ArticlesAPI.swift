...
open class ArticlesAPI {
    /**
     ...
     - parameter language: (query) language of articles (optional)
    ...
    open class func everythingGet(q: String, from: String, sortBy: String, apiKey: String, page: Int? = nil, language: String? = nil, completion: @escaping ((_ data: ArticleList?,_ error: Error?) -> Void)) {
        everythingGetWithRequestBuilder(q: q, from: from, sortBy: sortBy, apiKey: apiKey, page: page, language: language).execute { (response, error) -> Void in
     ...
     */
    open class func everythingGetWithRequestBuilder(q: String, from: String, sortBy: String, apiKey: String, page: Int? = nil, language: String? = nil) -> RequestBuilder<ArticleList> {
        let path = "/everything/"
